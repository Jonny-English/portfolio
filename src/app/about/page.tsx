                ...
                <section className="space-y-4">
                    ...
                    <ul className="space-y-6">
                        <li className="flex gap-4">
                            <span className="text-secondary font-mono text-sm pt-1 w-12 flex-shrink-0">2024-</span>
                            <div>
                                <h3 className="font-medium text-primary">Senior Product Designer</h3>
                                <p className="text-sm text-secondary">Tech Corp</p>
                            </div>
                        </li>
                        <li className="flex gap-4">
                            <span className="text-secondary font-mono text-sm pt-1 w-12 flex-shrink-0">2022-</span>
                            <div>
                                <h3 className="font-medium text-primary">Frontend Developer</h3>
                                <p className="text-sm text-secondary">Audit Studio</p>
                            </div>
                        </li>
                    </ul>
                </section>
